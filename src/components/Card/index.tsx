...
export function CardDemo({ className, ...props }: CardProps) {
  return (
    ...
    <div className="flex flex-col gap-4">
        ...
        <CardContent className="grid gap-4 text-start">
          ...
          <Card className="flex flex-col gap-2 p-5 pt-3">
            ...
            <div className="text-sm ">
              Rebuilt from the sound up AirPods Pro (2nd generation) with
              MagSafe Charging Case (USB-C) deliver up to 2x more Active Noise
              ...
              Audio that dynamically tailors noise control to your
              environment.¹⁶ Conversation Awareness helps lower media volume and
              enhance the voices in front of you while you’re interacting with
              others.¹⁶ A single charge delivers up to 6 hours of battery life.⁷
              And Touch control lets you easily adjust volume with a swipe. The
              MagSafe Charging Case¹⁷ is a marvel on its own with Precision
          ...
          <Card>
            <CardContent className="flex flex-col gap-2 p-5 pt-3 text-start">
              ...
              <div className="text-sm ">
                ...
                customizable fit for all-day comfort. Sweat and water
                resistant.¹ All in a super light, in-ear headphone that’s easy
                to set up with all your Apple devices.²
              </div>
            </CardContent>
          </Card>
          <Card>
            <CardContent className="flex flex-col gap-2 p-5 pt-3 text-start">
              ...
              <div className="text-sm ">
                AirPods Pro (each): 1.22 inches (30.9 mm) x 0.86 inch (21.8 mm)
                x 0.94 inch (24.0 mm); Wireless Charging Case: 1.78 inches (45.2
                mm) x 2.39 inches (60.6 mm) x 0.85 inch (21.7 mm)
              </div>
          ...
          <Card>
            <CardContent className="flex flex-col gap-2 p-5 pt-3 text-start">
              ...
              <div className="text-sm ">
                ...
                generation), iPhone XS, iPhone XS Max, iPhone XR, iPhone X,
                iPhone 8, iPhone 8 Plus
              </div>
              <div className="font-bold text-black">iPad Models</div>
              <div className="text-sm ">
                iPad Pro 12.9-inch (5th generation), iPad Pro 12.9-inch (4th
                generation), iPad Pro 12.9-inch (3rd generation), iPad Pro
                11-inch (3rd generation), iPad Pro 11-inch (2nd generation),
                iPad Pro 11-inch (1st generation), iPad Pro 10.5-inch, iPad Air
                (4th generation), iPad Air (3rd generation), iPad (9th
                generation), iPad (8th generation), iPad (7th generation), iPad
                mini (6th generation), iPad mini (5th generation)
              </div>
            </CardContent>
          </Card>
      ...
      <div className="py-7">
        THis is another card or similar to your designs
      </div>
      <AnotherCard />
    </div>
  );
...
const Headings2 = (props: HeadingsProps) => {
  return (
    <Card
      className={`w-fit p-2 gap-1 flex flex-col justify-center items-center ${
        props.isActive ? "border-black" : ""
      }`}
    >
      {props.icon}
...
const AnotherCard = ({ className, ...props }: CardProps) => {
  return (
    <Card className={cn("  max-w-[480px]", className)} {...props}>
      <CardHeader>
        <div className="mx-auto my-4 rounded-full overflow-hidden w-40 h-40 bg-gray-800">
      ...
      <CardContent className="grid gap-4 text-start">
        <div className="flex justify-between overflow-auto gap-4">
          <Headings2 icon={<FaBook />} title="Home" isActive />
          <Headings2 icon={<MdOutlineFormatListBulleted />} title="Setup" />
          <Headings2 icon={<IoBookOutline />} title="HandBook" />
          <Headings2 icon={<GiRecycle />} title="Recycle" />
          <Headings2 icon={<LuChevronRightSquare />} title="Company" />
          <Headings2 icon={<BsHandbag />} title="Store" />
        </div>
